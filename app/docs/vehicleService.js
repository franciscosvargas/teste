/**
    * @api {get} /api/v1/vehicleservice List All Vehicles services
    * @apiGroup VehicleService
    * @apiHeader {String} x-access-token Users unique access-key.
    * @apiSuccess {Object[]} vehicleservice Post's lists
    * @apiSuccess {String} analisar TEM Q ANALISAR AINDA
    * @apiExample {curl} Example usage:
    curl -X POST \
    http://localhost:3000/api/v1/vehicleservice \
...
/**
    * @api {post} /api/v1/vehicleservice Find One State
    * @apiGroup VehicleService
    * @apiHeader {String} x-access-token Users unique access-key.
    * @apiSuccess {Object[]} vehicleservice Post's lists
    * @apiSuccess {String} analisar TEM Q ANALISAR AINDA
