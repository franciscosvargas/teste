              ...
              <td class="content-wrap" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 20px;"
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                  ...
                  <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                    <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                      valign="top">
                      Você está ativo e a partir de agora já pode adquirir seus créditos, solicitar o atendimento dos melhores prestadores e assim atender mais diversas necessidades de entrega da sua empresa ou negócio. <br />
                      Esperamos lhe surpreender com a praticidade de nosso aplicativo, os preços mais justos, e ainda com a qualidade e disponibilidade dos prestadores integrados a nossa plataforma.<br />
                      Se tiver dúvidas, escreva pra gente :) <br />
                      Vamos começar?<br />
                    </td>
                  </tr>
                  <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
