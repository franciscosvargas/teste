                  ...
                  <tr>
                    <td align="center" valign="top">
                      <img src="https://cnet2.cbsistatic.com/img/H_zPLL8-QTZOLxJvgHQ1Jkz0EgY=/830x467/2013/07/10/f0bcef02-67c2-11e3-a665-14feb5ca9861/maps_routemap.png"
                        width="600" height="300" style="margin:0; padding:0; border:none; display:block;" border="0" alt=""
                      />
                    </td>
                  </tr>
                </table>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    ...
                    <td width="300" class="mobile" align="right" valign="top">
                      <img src="https://lh3.googleusercontent.com/VK-cvCdtTrwOk-60EuzY0WWFfwtNrlrrcWwl5e5oo13Y0sffOz0Mfak9XNtVEzITAw=w300-rw" width="75"
                        height="75" style="margin:0; padding:0; border:none; display:block;" border="0" alt="Logo Iuvo Club" />
                    </td>
                  </tr>
                  <tr>
                    <td align="left" valign="top" colspan="2">
                      <p>Obrigado por escolher o Iuvo Club, Higor</p>
                      <br>
                      <p>9 de janeiro de 2018 | Entrega</p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="left" valign="top" colspan="2" style="font-size: 16px; line-height: 66px">
                      <span class="route route-end"></span>23:40 |
                      <a href="#">R. Córrego do Ouro, 109 - Alto José Bonifacio, Recife - PE, 52280-280, Brazil</a>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" valign="top" colspan="2" style="font-size: 16px; line-height: 66px">
                      <span class="route route-start"></span>23:17 |
                      <a href="#">R. Desembarque Aeroporto, 31 - Ibura, Recife - PE, Brazil</a>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" valign="top" colspan="2">
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    <td width="100" class="mobile" align="left" valign="top">
                      <img src="https://img.kpopmap.com/2016/01/sm-rookies-kun-profile.jpg" width="75" height="75" style="border-radius:50%; margin:0; padding:0; border:none; display:block;"
                        border="0" alt="Prestador" />
                    </td>
                    <td width="400" class="mobile" align="center" valign="top">
                      <table cellpadding="0" cellspacing="0" border="1" class="wrapper" bgcolor="#FFFFFF" style="color:#93938b; text-align:center; border:solid 1px #93938b; border-collapse:collapse;height:50px;
                      width:300px">
                        <caption height="50" style="line-height:50px;">
                          Você viajou com Higor
                        </caption>
                        <thead border="1">
                          <th>Quilômetros</th>
                          <th>Duração</th>
              ...
              <td align="center" valign="top">
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    ...
                    <td width="400" class="mobile" align="center" valign="top">
                      <p>
                        O preço de serviço não inclui taxas que possam ser cobradas pelo seu banco. Entre em contato diretamente com o seu banco
            ...
            <tr>
              <td align="center" valign="top">
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  <tr>
                    <td width="100" class="mobile" align="left" valign="top">
                      <img src="https://lh3.googleusercontent.com/Yce_6y19DV-ktbmUfOyMOY9hm3_3_fV3tWu9SPzaUhuZhcmh6sb7lWEEe8FsfJkZs0cJ=w300-rw"
                        width="100" height="80" style="margin:0; padding:0; border:none; display:block;" border="0" alt="Iuvo Club"
                      />
                    </td>
